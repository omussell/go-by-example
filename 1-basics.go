...
func main() {
    ...
    const n = 500000000 // Constants can appear anywhere a var statement can

    const g = 3e20 / n // Constant expressions perform arithmetic with arbitrary precision
    ...
    fmt.Println(math.Sin(n)) // Prints -0.28470407323754404. A number can be given a type by using it in a context that requires one, such as a variable assignment or function call. Here, math.Sin expects a float64.
